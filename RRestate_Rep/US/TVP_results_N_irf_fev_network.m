...
title('Average Response of US Return over Great Recession')
ylabel('%')
xlabel('Horizon')
subplot(2,1,2)
...
colormap autumn
axis tight
matlab2tikz('US_IRF_RTOV_N_20.tex')
...
shadenber()
title('US')
matlab2tikz('US_FEVD_ILLIQ_RTOV_N.tex')
%%
...
colormap autumn
axis tight
matlab2tikz('US_IRF_IV_N_20.tex')
...
shadenber()
title('US')
matlab2tikz('US_FEVD_ILLIQ_IV_N.tex')
%%
% Now for network stuff
